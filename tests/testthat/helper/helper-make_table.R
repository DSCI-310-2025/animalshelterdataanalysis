...
make_table(test_data1, ".", "data/make_table_test_data1.csv")
make_table(test_data2, ".", "data/make_table_test_data2.csv")
make_table(test_data3, ".", "data/make_table_test_data3.csv")
